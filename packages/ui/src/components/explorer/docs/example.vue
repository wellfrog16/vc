                    ...
                    <VcExplorerPanel :padding="0">
                        <VcExplorer layout="vertical">
                            <VcExplorerPanel resizable>
                                ...
                                <VcExplorerTable ref="tableRef" :data="tableData" row-key="date" custom-selection="radio" :column-config="tableColumn" :column-render="columnRender" @column-event="(column, row, val) => { console.log(column, row, val) }">
                                    <template #operation>
