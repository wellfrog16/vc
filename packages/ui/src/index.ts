...
export { default as VcExplorerContainer } from './components/explorer-form/explorer-form.vue'
...
export { default as VcExplorerTools } from './components/explorer-tools/explorer-tools.vue'
export { default as VcExplorerTree } from './components/explorer-tree/explorer-tree.vue'
...
export { default as VcSplitterPanel } from './components/splitter-panel/splitter-panel.vue'
export { default as VcSplitter } from './components/splitter/splitter.vue'
