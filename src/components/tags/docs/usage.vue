...
const documentData = {
    params: [
        ...
        { param: 'regexp', description: 'tag值的校验规则', type: 'RegExp', defaultValue: '/\\S+/' },
        ...
        { param: 'value-format', description: '结果格式化', type: '(val: string | number) => string | number', defaultValue: (val: string | number) => {} },
    ],
    events: [
